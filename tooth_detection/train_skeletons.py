...
parser.add_argument('--exp', type=str,  default='skeletons', help='model_name')
...
if __name__ == "__main__":
    ...
    for epoch_num in tqdm(range(max_epoch), ncols=70):
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            volume_batch, offset_batch, label_batch = sampled_batch['image'], sampled_batch['offset_skl'], sampled_batch['label']
